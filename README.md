# Проект React.js + Node.js - Raschitalochka
...
[Оригинал репозитория и автор данного бэкенда Виктор Бульваренко, в случае чего дополнительные вопросы к нему](https://github.com/vbguard/rashchitalo4ka-back-end)
